...
int main(int argc, char* argv[]) {
  ...
  gc.newCombiner(1, "Lb2pktaul_1", "Gaus 1", 1);
  gc.newCombiner(2, "Lb2pktaul_2", "Gaus 2", 2);
  gc.newCombiner(3, "Lb2pktaul_3", "Gaus 1 & Gaus 2", 1, 2);
  gc.newCombiner(4, "Lb2pktaul_4", "2D Gaus", 3);
  gc.newCombiner(5, "Lb2pktaul_5", "2D Gaus + Gaus 1", 2, 3);
  gc.newCombiner(6, "Lb2pktaul_6", "Circle", 4);
  gc.newCombiner(7, "Lb2pktaul_7", "2D Gaus + Circle", 3, 4);
