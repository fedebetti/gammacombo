...
int main(int argc, char* argv[]) {
  ...
  // In this Lb2pktaul, this is done by calling the command Lb2pktaul_dataset_build_workspace
  ...
  //        --nbatchjobs 100 --batchstartn 1 --batchreqs ../scripts/cern_condor_reqs_1hour.txt  --batchsubmit
  ...
  if (workspace == nullptr) {
    ...
    std::cout << "You can create the workspace by calling the Lb2pktaul_dataset_build_workspace command. " << std::endl;
    std::cout << "The corresponding code can be found in Lb2pktaul_dataset_build_workspace.cpp" << std::endl;
  }
