...
int main(int argc, char* argv[]) {
  ...
  //        bin/tutorial_dataset -a pluginbatch --var branchingRatio --npoints 50 --scanrange 0.:1.e-6 --ntoys 100
  //        --nrun 1 bin/tutorial_dataset -a pluginbatch --var branchingRatio --npoints 50 --scanrange 0.:1.e-6 --ntoys
  //        100 --nrun 2 bin/tutorial_dataset -a pluginbatch --var branchingRatio --npoints 50 --scanrange 0.:1.e-6
  //        --ntoys 100 --nrun 3 bin/tutorial_dataset -a pluginbatch --var branchingRatio --npoints 50 --scanrange
  //        0.:1.e-6 --ntoys 100 --nrun 4 bin/tutorial_dataset -a pluginbatch --var branchingRatio --npoints 50
  ...
  //        bin/tutorial_dataset -a plugin --var branchingRatio --npoints 50 --scanrange 0.:1.e-6 -j 1-5 -a plot --cls 1
  //        --cls 2
