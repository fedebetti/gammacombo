...
parser.add_option(
    "-i",
    "--inputfile",
    help="The .root file which has the canvas in it which you want to 'dress up'",
)
parser.add_option(
    "-o",
    "--outputfile",
    default="dressed_plot",
    help="File to write the plots to (no extension and no path)",
)
parser.add_option(
    "-x", "--xaxis", type="str", default=None, help="Set the xaxis range e.g --x 0:10"
)
parser.add_option(
    "-y", "--yaxis", type="str", default=None, help="Set the yaxis range e.g --y 0:10"
)
parser.add_option(
    "-d",
    "--dressModule",
    type="str",
    default=None,
    help="Dress with this additional module",
)
parser.add_option(
    "-l", "--keepleg", default=False, action="store_true", help="Keep the legend"
)
parser.add_option(
    "-b", "--batch", default=False, action="store_true", help="Run in batch mode"
)
