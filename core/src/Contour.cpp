...
namespace {
  std::pair<int, int> findClosestPoints(TGraph* g1, TGraph* g2) {
    int i1, i2;
   ...
   *
   * If a contour looks like a ring, it is initially stored as two independent circles in the TList. Here we join them,
   * if one lies inside the other, such that when the resulting contour is plotted, the plot will actually have a hole.
   *
