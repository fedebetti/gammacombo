...
/**
 * Return a std::vector of all parameter names present in this combination.
 *
...
/**
 * Return a std::vector of all observables names present in this combination.
 *
