...
class ToyTree
{
    public:
        ...
        float chi2minBkgToy = 0.;       ///< the chi2 of the fit of the hypothesis value to the bkg toy distribution (for CLs method)
        ...
        float scanbestBkgfitBkg = 0.;   ///< an alias to the fit value of the scan variable of the bkg fit on the bkg only toy (for CLs method)
