...
class PDF_Datasets : public PDF_Abs {
 public:
  ...
  inline bool notSetupToFit(bool fitToys) {
 ...
 protected:
  ...
  TString globalParsName;  //> name of the set of global parameters in the workspace, that is, the parameters that occur
                           //(not only) in the  constraints...
