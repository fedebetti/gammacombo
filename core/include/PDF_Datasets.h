...
class PDF_Datasets : public PDF_Abs {
 ...
 protected:
  ...
  TString globalParsName =
      "default_internal_global_pars_set_name";  //> name of the set of global parameters in the workspace, that is, the
                                                // parameters that occur (not only) in the  constraints...
  TString globalObsName =
      "default_internal_global_obs_set_name";  //> name of the set of global observables in the workspace.
