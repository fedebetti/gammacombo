...
class OptParser {
 public:
  ...
  float plotlegx = -99.f;
  float plotlegy = -99.f;
  float plotlegsizex = -99.f;
  float plotlegsizey = -99.f;
  TString plotlegstyle = "default";
  int plotlegcols = 1;
  bool plotlegbox = false;
  float plotlegboxx = -99.f;
  float plotlegboxy = -99.f;
  float plotgroupx = -99.f;
  float plotgroupy = -99.f;
  ...
  float plotoriginx = -99.f;
  float plotoriginy = -99.f;
  ...
  float plotymax = -99.f;
  bool intprob = false;
  float pluginPlotRangeMin = -100.f;
  float pluginPlotRangeMax = -100.f;
  bool probforce = false;
  bool probimprove = false;
  TString probScanResult = "notSet";
  bool printcor = false;
  float printSolX = -999.f;
  float printSolY = -999.f;
  std::vector<int> qh;
  // TString queue;
  ...
  float scanrangeMin = -101.f;
  float scanrangeMax = -101.f;
  float scanrangeyMin = -102.f;
  float scanrangeyMax = -102.f;
  float scaleerr = -999.f;
  float scalestaterr = -999.f;
  bool smooth2d = false;
  bool square = false;
  int teststatistic = 2;
