...
class OptParser {
 public:
  ...
  std::vector<double> filltransparency;
 ...
 private:
  ...
  bool parseRange(TString parseMe, double& min, double& max) const;
  bool parseAssignment(TString parseMe, TString& name, TString& value) const;
  bool parseAssignment(TString parseMe, TString& name, double& value) const;
