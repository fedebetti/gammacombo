...
class RooBinned2DBicubicBase : public BASE {
 ...
 public:
  ...
  RooBinned2DBicubicBase(const char* name, const char* title, const TH2& h, RooAbsReal& xvar, RooAbsReal& yvar);
  /// copy constructor
  RooBinned2DBicubicBase(const RooBinned2DBicubicBase<BASE>& other, const char* name = 0);
  /// assignment operator
  ...
  virtual Int_t getAnalyticalIntegral(RooArgSet& allVars, RooArgSet& integVars, const char* rangeName = 0) const;
 ...
 private:
  ...
  inline const BASE& base() const { return *reinterpret_cast<const BASE*>(this); }
  /// convenience access to base class
  inline BASE& base() { return *reinterpret_cast<BASE*>(this); }

  /// const access to coefficients
  inline SharedArray<double>::RWProxy coeff(int binx, int biny, int coeff) const {
