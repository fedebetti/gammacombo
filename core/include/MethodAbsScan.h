...
class MethodAbsScan {
 public:
  ...
  vector<vector<RooSlimFitResult*>> curveResults2d;  ///< All fit results of the the points that make it into the 1-CL
                                                     ///< curve.
  ...
  vector<CLInterval> clintervalsuser;    ///< all intervals with an additional user specific CL that were found by
                                         ///< calcCLintervals()
