...
public:
    ...
    void        drawBBPoints(TString varX, TString varY, int runMin=1, int runMax=1, bool save=true) const; ///< Draws 2D Histogram showing the BB points in varX-varY space
