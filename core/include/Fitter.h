...
public:
    ...
    RooArgSet const * startparsFirstFit = nullptr;  ///< start parameters to be used by all fit routines that run one fit, and by the first fit of fitTwice()
    RooArgSet const * startparsSecondFit = nullptr; ///< start parameters to be used by the second fit of fitTwice()
